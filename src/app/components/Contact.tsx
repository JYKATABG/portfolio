...
export default function Contact() {
    ...
    return (
        <section
            id="contact"
            className="flex flex-col xl:justify-evenly justify-end gap-5 xl:w-[1366px]
            xl:m-auto mt-[34em] mb-[7em] xl:px-0 px-2.5">
            <h1 className="text-center xl:text-[2.5em] text-2xl font-bold xl:mb-[2em] mb-[1em]">CONTACT</h1>
            <motion.div
                className="flex xl:flex-row flex-col justify-between"
                viewport={{ once: true }}
                initial="hidden"
                whileInView="visible"
                variants={variants}
            >
                <div className="xl:w-[600px] w-[350px] flex flex-col xl:gap-0 gap-5 justify-between">
                    <Reveal>
                        <p className="xl:text-xl text-lg max-w-[19em] text-center">If I fit the profile of the candidate you're seeking,
                    ...
                    <Reveal>
                        <div className="flex items-center justify-start gap-5 xl:text-xl text-lg xl:mb-0 mb-[2em]">
                            <MdEmail />
